        ...
        <Section>
            ...
            `, //https://pub-c5e31b5cdafb419fb247a8ac2e78df7a.r2.dev/public/assets/background/background-6.webp
                ...
                <Box sx={{
                    ...
                    // background: `linear-gradient(to left, ${theme.palette.primary.light} 80%, ${theme.palette.primary.dark} 80%)`,
                     zIndex: -1,
                ...
                <Image img={'/assets/w-logo.png'} ratio={'auto'} sx={{ maxWidth: "250px" }} />
