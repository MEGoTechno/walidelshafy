...
export default function MakeForm({ inputs, status = {}, onSubmit, btnWidth, enableReinitialize = true, modalInfo, formDirection, btnStyle, submitBtnStatus = false, disabledBtn, allowDirty, preValue = null, isResetNewVal = false }) {
